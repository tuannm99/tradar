...
fn context_title(context: Context) -> &'static str {
    match context {
        ...
        Context::VimNormal => "Query editor — Normal mode (when focused)",
        Context::VimVisual => "Query editor — Visual mode (when focused)",
        Context::VimMotion => "Query editor — motions, Normal + Visual (when focused)",
